...
if (iDataSet == 1)                                % Training
 ...
 %%
 elseif (iSlope== 2)
   alpha = 5 - 2*sin(x/50) + cos(sqrt(3)*x/100);  
 elseif (iSlope== 3)
   alpha = 2 + (x/1000) + sin(x/50) + cos(sqrt(2)*x/100);  
elseif (iSlope== 4)
   alpha = 3 - 2*sin(x/100) + cos(sqrt(2)*x/100); 
elseif (iSlope== 5)
   alpha = 4 + (x/1000) + 2*sin(x/100) + cos(sqrt(3)*x/50); 
elseif (iSlope== 6)
   alpha = 4 + (x/700) + sin(x/100) + cos(sqrt(3)*x/50); 
elseif (iSlope== 7)
   alpha = 3 + (x/500) + sin(x/1000) + cos(sqrt(7)*x/100); 
elseif (iSlope== 8)
   alpha = 5 + sin(x/100) + cos(sqrt(5)*x/50); 
elseif (iSlope== 9)
   alpha = 4 + (x/700) + sin(x/100) + cos(sqrt(5)*x/50); 
 %% 
 elseif (iSlope== 10)
...
elseif (iDataSet == 2)                            % Validation
 if (iSlope == 1) 
   alpha = 5 - sin(x/100) + cos(sqrt(3)*x/50);    % You may modify this!
 %%
 elseif (iSlope == 2) 
   alpha = 3 - sin(x/50) + cos(sqrt(7)*x/50);   
 elseif (iSlope == 3) 
   alpha = 5 + (x/1000) - sin(x/50) + cos(sqrt(3)*x/100);
 elseif (iSlope == 4) 
...
elseif (iDataSet == 3)                           % Test
 ...
 %%
 elseif (iSlope == 2) 
   alpha = 5 - sin(x/75) - cos(sqrt(6)*x/75);   % You may modify this!
 elseif (iSlope == 3) 
   alpha = 4 + sin(x/100) - cos(sqrt(3)*x/100);   % You may modify this!
 elseif (iSlope == 4) 
   alpha = 6 - sin(x/100) - cos(sqrt(7)*x/50);   % You may modify this!
 %% 
 elseif (iSlope == 5)
   alpha = 5 + (x/1000) + sin(x/70) + cos(sqrt(7)*x/100); % You may modify this!
 end
end
